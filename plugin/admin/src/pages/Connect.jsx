        ...
        blocks: [
          ...
          },
          {
            ...
            value: [
              ...
              { label: 'Command to launch', value: 'npx' },
              { heading: 'Arguments' },
            ...
            steps: [
              'Open Codex Desktop → <strong>Settings</strong> → <strong>Plugins</strong> → <strong>MCPs</strong> tab',
              'Click <strong>Add</strong> to connect to a custom MCP',
              'Keep <strong>Type</strong> set to <strong>STDIO</strong> (the default)',
              'Fill in <strong>Name</strong> and <strong>Command to launch</strong> below',
              'Click <strong>Add argument</strong> twice and enter Argument 1 and Argument 2 below',
              'Click <strong>Add environment variable</strong> three times and enter the three variables below',
              'Leave <strong>Environment variable passthrough</strong> and <strong>Working directory</strong> empty',
...
function buildOAuth(serverName, serverUrl) {
  ...
  const perAgent = {
    ...
    'codex-desktop': [{
      ...
      steps: [
        'Open Codex Desktop → <strong>Settings</strong> → <strong>Plugins</strong> → <strong>MCPs</strong> tab',
        'Click <strong>Add</strong> to connect to a custom MCP, then switch the type to <strong>Streamable HTTP</strong>',
        'Enter the name below and paste the URL into the <strong>URL</strong> field',
        'Leave <strong>Bearer token env var</strong> and <strong>Headers</strong> empty — Codex handles OAuth sign-in itself once connected',
        'Click <strong>Save</strong>, then sign in to this site and click <strong>Authorize</strong>',
      ],
    }],
    'other': [{
      ...urlBlock,

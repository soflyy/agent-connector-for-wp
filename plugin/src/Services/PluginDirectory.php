...
final class PluginDirectory {
	...
	/**
	 * Folder slugs the Universal Abilities companion plugin has shipped under.
	 *
	 * It was renamed from "Default Abilities" (folder `default-abilities-plugin`)
	 * to "Universal Abilities" (folder `universal-abilities-plugin`). Detecting both
	 * means a site that installed the pre-rename release is still recognized as
	 * having the pack, instead of being prompted to install a duplicate.
	 *
	 * @var array<int,string>
	 */
	public const UNIVERSAL_ABILITIES_SLUGS = array( 'universal-abilities-plugin', 'default-abilities-plugin' );
	...
	/**
	 * Resolve the Universal Abilities companion plugin's installed file, tolerating
	 * its pre-rename folder name, or null when it isn't installed under any known slug.
	 */
	public static function universal_abilities_file(): ?string {
		foreach ( self::UNIVERSAL_ABILITIES_SLUGS as $slug ) {
			$file = self::installed_file_for_slug( $slug );
			if ( null !== $file ) {
				return $file;
			}
		}
	...
	/**
	 * Whether the Universal Abilities companion plugin is installed AND active, under
	 * either its current (`universal-abilities-plugin`) or legacy
	 * (`default-abilities-plugin`) folder name.
	 */

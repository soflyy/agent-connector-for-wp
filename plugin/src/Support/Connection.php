 ...
 * OAuth is preselected, except on local environments, where the application
 * password leads and OAuth is flagged as possibly not working (hosted agents
 * can't reach a local site to complete the flow; agents running on the same
 * machine usually can).
 */
